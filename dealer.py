...
def main():
    ...
    while(True):
        ...
        time.sleep(1)
        while(i < NO_OF_PLAYERS):
            data = 'req=data:' + 'nop=' + str(NO_OF_PLAYERS) + ';live=' + str(live_players) + ';yourPos=' + str(i) + ";sb=" + str(small_blind) + ";current_player=" + str(current_player) + ";NO_OF_POTS=" + str(no_of_pots) + ";players_money=" + str(players_money) + ";pot_investment=" +str(pot_investment) + ";last_raised_amt=" + str(last_raised_amt)
            thread.start_new_thread(send_data, (data,i,))
            i += 1
        ...
        p_list = get_player_list(current_round)
        print p_list
        for player in p_list:
            ...
            if req_type == 'raiseTO':
                ...
                last_raised_amt += last_raised_by
                ...
                time.sleep(1)
                send_them_all('req=data:current_player=' + str(current_player) + ';last_raised_amt=' + str(last_raised_amt) + ';last_raised_by=' + str(last_raised_by) + ';players_money=' + str(players_money) + ';pot_investment=' + str(pot_investment)) 
                break
